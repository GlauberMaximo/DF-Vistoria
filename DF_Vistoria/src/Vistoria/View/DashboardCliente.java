...
public class DashboardCliente extends JFrame {
    ...
    public DashboardCliente() {
        ...
        // Botões de menu (substituir os ícones pelos seus arquivos se tiver)
        ...
        panelLeft.add(Box.createVerticalStrut(30)); // espaçamento
        panelLeft.add(btnDashboard);
        panelLeft.add(btnAgendar);
        panelLeft.add(btnCadastrar);
        panelLeft.add(btnLaudo);
        panelLeft.add(Box.createVerticalGlue()); // empurra o botão "Sair" para baixo
