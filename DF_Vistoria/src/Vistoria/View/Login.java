    ...
    public Login() {
        ...
        gl.setHorizontalGroup(
                gl.createParallelGroup(Alignment.LEADING)
                        .addGroup(gl.createSequentialGroup().addGap(120)
                                .addGroup(gl.createParallelGroup(Alignment.TRAILING)
                                        ...
                                        .addComponent(txtUsuario, Alignment.LEADING, GroupLayout.PREFERRED_SIZE, 200, GroupLayout.PREFERRED_SIZE)
                                        .addComponent(lblUsuario, Alignment.LEADING)))
                        .addGroup(gl.createSequentialGroup().addGap(156)
                        ...
                        .addGroup(gl.createSequentialGroup().addGap(138)
                                .addComponent(Titulo).addContainerGap(160, Short.MAX_VALUE)));
        gl.setVerticalGroup(gl.createParallelGroup(Alignment.LEADING)
                .addGroup(gl.createSequentialGroup().addGap(137)
                        .addComponent(Titulo).addGap(18)
                        ...
                        .addComponent(lblSenha).addPreferredGap(ComponentPlacement.RELATED)
                        .addComponent(txtSenha, GroupLayout.PREFERRED_SIZE, 28, GroupLayout.PREFERRED_SIZE)
                        .addGap(18).addComponent(btnLogin, GroupLayout.PREFERRED_SIZE, 35, GroupLayout.PREFERRED_SIZE)
    ...
    private void autenticar() {
        ...
        if (funcionario != null) {
            ...
            if (cargo != null) {
                switch (cargo) {
                    case "Vistoriador":
                        new DashboardVistoria().setVisible(true);
                        break;
                    case "Gerente":
                        // new DashboardGerente().setVisible(true);
                        break;
                    default:
                        JOptionPane.showMessageDialog(this, "Cargo de funcionário não reconhecido.", "Erro", JOptionPane.ERROR_MESSAGE);
                        break;
                }
            }
            return;
